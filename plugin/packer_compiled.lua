...
_G.packer_plugins = {
  ...
  coq_nvim = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/ma/.local/share/nvim/site/pack/packer/opt/coq_nvim",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'fzf', 'which-key.nvim', 'lualine.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
