...
_G.packer_plugins = {
  ...
  fzf = {
    loaded = true,
    path = "/home/ma/.local/share/nvim/site/pack/packer/start/fzf",
  ...
  ["fzf.vim"] = {
    loaded = true,
    path = "/home/ma/.local/share/nvim/site/pack/packer/start/fzf.vim",
  ...
  ["nvim-gps"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/ma/.local/share/nvim/site/pack/packer/opt/nvim-gps",
